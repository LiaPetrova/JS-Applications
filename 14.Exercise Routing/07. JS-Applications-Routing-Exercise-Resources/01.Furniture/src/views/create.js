...
const createTemplate = (onSubmit, errorMsg, errors) => 
    html`
      ${errorMsg
      ...
      <div class="row space-top">
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input
              class=${"form-control valid" + (errors.make ? ' is-invalid' : '')}
              id="new-make"
              type="text"
              name="make"
            />
          ...
          <div class="form-group has-success">
            ...
            <input
              class=${"form-control valid" + (errors.model ? ' is-invalid' : '')}
              id="new-model"
              type="text"
              name="model"
            />
          ...
          <div class="form-group has-danger">
            ...
            <input
              class=${"form-control valid" + (errors.year ? ' is-invalid' : '')}
              id="new-year"
              type="number"
              name="year"
            />
          ...
          <div class="form-group">
            ...
            >
            <input
              class=${"form-control valid" + (errors.description ? ' is-invalid' : '')}
              id="new-description"
              type="text"
              name="description"
            />
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            <input
              class=${"form-control valid" + (errors.price ? ' is-invalid' : '')}
              id="new-price"
              type="number"
              name="price"
            />
          </div>
          <div class=${"form-control valid" + (errors.img ? ' is-invalid' : '')}>
